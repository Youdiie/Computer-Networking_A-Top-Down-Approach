...
먹튀 방지 알고리즘 = 다운로드 대비 업로드가 낮은 시드를 리치로 판별
![image](https://github.com/Youdiie/Computer-Networking_A-Top-Down-Approach/assets/87409148/b48e6c49-83ab-4583-8abf-6e3b42bfd239)

다운로드 후 토렌트 파일을 지워 업로드를 하지 않는 시드를 찾아내 토렌트 속도를 늦추거나 아예 다운을 못하게 해 먹튀를 방지한다.
